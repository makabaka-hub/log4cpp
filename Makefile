...
pkgdatadir = $(datadir)/log4cpp
pkgincludedir = $(includedir)/log4cpp
pkglibdir = $(libdir)/log4cpp
pkglibexecdir = $(libexecdir)/log4cpp
...
am__aclocal_m4_deps = $(top_srcdir)/m4/ACX_PTHREAD.m4 \
	$(top_srcdir)/m4/AC_CREATE_PREFIX_CONFIG_H.m4 \
	...
	$(top_srcdir)/m4/BB_ENABLE_REMOTE_SYSLOG.m4 \
	$(top_srcdir)/m4/BB_ENABLE_SMTP.m4 \
...
CONFIG_CLEAN_FILES = log4cpp.spec log4cpp.pc log4cpp-config
...
CTAGS = ctags
CSCOPE = cscope
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/log4cpp-config.in \
	$(srcdir)/log4cpp.pc.in $(srcdir)/log4cpp.spec.in \
...
ACLOCAL = ${SHELL} /home/yii/work/env_src/log4cpp/config/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/yii/work/env_src/log4cpp/config/missing autoconf
AUTOHEADER = ${SHELL} /home/yii/work/env_src/log4cpp/config/missing autoheader
AUTOMAKE = ${SHELL} /home/yii/work/env_src/log4cpp/config/missing automake-1.16
AWK = mawk
CC = gcc
...
LT_SYS_LIBRARY_PATH = 
LT_VERSION = 5:6:0
MAKEINFO = ${SHELL} /home/yii/work/env_src/log4cpp/config/missing makeinfo
MANIFEST_TOOL = :
...
STRIP = strip
VERSION = 1.1
abs_builddir = /home/yii/work/env_src/log4cpp
abs_srcdir = /home/yii/work/env_src/log4cpp
abs_top_builddir = /home/yii/work/env_src/log4cpp
abs_top_srcdir = /home/yii/work/env_src/log4cpp
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/yii/work/env_src/log4cpp/config/install-sh
...
$(am__aclocal_m4_deps):
log4cpp.spec: $(top_builddir)/config.status $(srcdir)/log4cpp.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
log4cpp.pc: $(top_builddir)/config.status $(srcdir)/log4cpp.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
log4cpp-config: $(top_builddir)/config.status $(srcdir)/log4cpp-config.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
